...
class Knight:
    ...
    def turn_survival_start2(self, enemy):
        knight_health = self.health  # save the initial health of the Knight
        ...
        print("""
            MARCUS                      
             ...
             / /\\ \\
                 ...
                 In fact, I don't even care. I will kill you with my own hands!
                ...
                print("""
                    MARCUS  
                     ...
                     / /\\ \\
                         ...
                         You're kind of brave for a splinter like you.
                ...
                print("""
                    MARCUS                      
                     ...
                     / /\\ \\
                         ...
                         I say don't celebrate yet.
                         You have four more than me to defeat, or maybe even stronger.
        ...
        print("""
            BUFFALLO                      
             ...
             / /\\ \\
                 ...
                 I don't know you, I have no idea what you are, but one thing is for sure:
        ...
        print("""
            BUFFALLO                      
             ...
             / /\\ \\
                 ...
                 I will take your breath away in seconds with my sword!
            ...
            if enemy.health <= 0:
                ...
                BUFFALLO                      
                 ...
                 / /\\ \\
                         ...
                         There are too many whispers in my head!
                ...
                BUFFALLO                      
                 ...
                 / /\\ \\
                         ...
                         It's not late to come back...
                         Ahh... I feel like my head is popping up!!!
                ...
                clear_screen()  # Recursively call the function to clear the screen again
                print("""
                    <Buffallo fainted as he was struck by an invisible force...>
                """)
                time.sleep(1)
                print("Press any key to continue...")
                msvcrt.getch()  # Wait for user input to continue
                clear_screen()  # Recursively call the function to clear the screen again
                print("""
                    <He is totally unconscious on the ground.>
                """)
                time.sleep(3)
                print("Press any key to continue...")
                msvcrt.getch()  # Wait for user input to continue
        ...
        print("""
            KARL
             ...
             / -- \\
                 ...
                 You are ambitious by nature, I see.
        ...
        print("""
            KARL
             ...
             / -- \\
                 ...
                 But you have exceeded every measure!
        ...
        print("""
            KARL
             ...
             / -- \\
                 ...
                 But you have exceeded every measure!
                 So, let me show you the price you have to pay, you moron!
                ...
                print("""
                    KARL
                     ...
                     / -- \\
                         ...
                         You don't understand how powerfull is that Knight...
                ...
                print("""
                    KARL
                     ...
                     / -- \\
                         ...
                         It's pure suicide!
                         I'm out of here! I will not witness such a disaster!
                ...
                print("""
                    KARL
                     ...
                     / -- \\
                         ...
                         You still have time to run away from here, believe me.
    ...
    def bodyguard1(self, enemy):
        ...
        print("""
            MAGE
             ...
             / -- \\
                 ...
                 I wouldn't dare you move on. But it's your job.
        ...
        while win:
            ...
            if enemy.health <= 0:
                ...
                print("""
                    MAGE
                     ...
                     / -- \\
                         ...
                         My defeat means nothing, anyway.
                ...
                print("""
                    MAGE
                     ...
                     / -- \\
                         ...
                         The disaster that follows will destroy everything in its path, including you!
                ...
                time.sleep(4)
                print("""
                         <Some footsteps of solid armor are heard louder and louder...> 
                """)
                time.sleep(3)
                print("Press any key to continue...")
                msvcrt.getch()  # Wait for user input to continue
                clear_screen()  # Recursively call the function to clear the screen again
                print("""
                         <The strange thing is that no knight is seen...> 
                """)
                time.sleep(3)
                print("Press any key to continue...")
                msvcrt.getch()  # Wait for user input to continue
                ...
                time.sleep(4)
                print("""
                         <Other strange noises were heard...> 
                """)
                time.sleep(2)
                print("Press any key to continue...")
                msvcrt.getch()  # Wait for user input to continue
                clear_screen()  # Recursively call the function to clear the screen again
                print("""
                         <However, it was like they weren't from this world...> 
                """)
                time.sleep(3)
                print("Press any key to continue...")
                msvcrt.getch()  # Wait for user input to continue
                ...
                print("""
                    MAGE
                     ...
                     / -- \\
                         ...
                         Something is heard coming towards us... You stupid old man!
    ...
    def bodyguard2(self, enemy):
        ...
        print("""
            OTORPHEUS
             ...
             /    \\
                 ...
                 Stay away from the castle and the Knight, otherwise your existence will end, beast that you are!
        ...
        while win:
            ...
            if enemy.health <= 0:
                ...
                clear_screen()  # Recursively call the function to clear the screen again
                print("""
                    <And the road leading back to the foot of the mountain has broken...>
                """)
                time.sleep(3)
                print("Press any key to continue...")
                msvcrt.getch()  # Wait for user input to continue
                clear_screen()  # Recursively call the function to clear the screen again
                print("""
                    <Hundreds of stones fell from the mountain...>
                """)
                time.sleep(3)
                print("Press any key to continue...")
                msvcrt.getch()  # Wait for user input to continue
                clear_screen()  # Recursively call the function to clear the screen again
                print("""
                    <A moment of silence for those defeated so far. They had no escape.>
                """)
                time.sleep(3)
                print("Press any key to continue...")
                msvcrt.getch()  # Wait for user input to continue
                ...
                print("""
                    OTORPHEUS
                     ...
                     /    \\
                         ...
                         Now, I'll have to find another escape while I still have time.
...
def survival():
    ...
    if cnt1 > 20:
        ...
        while cnt >= 0:
            if cnt == 10:
                clear_screen()
                knight.turn_survival_start2(solider)
                print(KN_survival2)
                print("Press any key to continue...")
                msvcrt.getch()  # Wait for user input to continue
                clear_screen()  # Recursively call the function to clear the screen again
...
def bodyguards1():
    with open("Bodyguards.txt", "r") as f:
        cnt = int(f.read())
    if cnt == 5:     
        clear_screen()
        print("<Now, you can view your fighter data:>")
        ...
        knight.load_data("knight.txt")
        #knight.print_attributes()
        Marcus = Knight("Marcus", "Marcus's Sword", "The Last Gold Platemail")
        time.sleep(5)
        print("Press any key to continue...")
        msvcrt.getch()  # Wait for user input to continue
        clear_screen()  # Recursively call the function to clear the screen again
    ...
    if cnt == 4:     
        ...
        knight.load_data("knight.txt")
        #knight.print_attributes()
        Buffallo = Knight("Buffallo", "Buffallo's Sword", "Buffallo's Platemail")
        time.sleep(5)
        print("Press any key to continue...")
        msvcrt.getch()  # Wait for user input to continue
        clear_screen()  # Recursively call the function to clear the screen again
    ...
    if cnt == 3:     
        ...
        knight.load_data("knight.txt")
        #knight.print_attributes()
        Karl = Knight("Karl", "Obsidian Axe", "Karl's Chainmail")
        time.sleep(5)
        print("Press any key to continue...")
        msvcrt.getch()  # Wait for user input to continue
        clear_screen()  # Recursively call the function to clear the screen again
    ...
    if cnt == 2:     
        ...
        knight.load_data("knight.txt")
        #knight.print_attributes()
        Otorpheus = Knight("Otorpheus", "Otorpheus's Sword", "Otorpheus's Platemail")
        time.sleep(5)
        print("Press any key to continue...")
        msvcrt.getch()  # Wait for user input to continue
        clear_screen()  # Recursively call the function to clear the screen again
    ...
    if cnt == 1:
        ...
        knight.load_data("knight.txt")
        #knight.print_attributes()
        Mage = Knight("Mage", "Mage's Staff", "Otorpheus's Platemail")
        time.sleep(5)
        print("Press any key to continue...")
        msvcrt.getch()  # Wait for user input to continue
        clear_screen()  # Recursively call the function to clear the screen again
    ...
    if cnt == 0:
        ...
        knight.load_data("knight.txt")
        #knight.print_attributes()
        Morrow = Knight("Morrow", "Raven Heart", "Gold Katana")
        time.sleep(5)
        print("Press any key to continue...")
        msvcrt.getch()  # Wait for user input to continue
        clear_screen()  # Recursively call the function to clear the screen again
